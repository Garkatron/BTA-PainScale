...
public class ArmorSets {
	...
	public static void initialize() {
		...
		register(20, Items.ARMOR_BOOTS_CHAINMAIL, Items.ARMOR_LEGGINGS_CHAINMAIL, Items.ARMOR_CHESTPLATE_CHAINMAIL, Items.ARMOR_HELMET_CHAINMAIL);
		register(20, Items.ARMOR_BOOTS_CHAINMAIL, Items.ARMOR_LEGGINGS_CHAINMAIL);
		register(20, Items.ARMOR_CHESTPLATE_CHAINMAIL, Items.ARMOR_HELMET_CHAINMAIL);

		register(40, Items.ARMOR_BOOTS_IRON, Items.ARMOR_LEGGINGS_IRON, Items.ARMOR_CHESTPLATE_IRON, Items.ARMOR_HELMET_IRON);
